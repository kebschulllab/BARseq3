...
## Data
- `BARseq2_Barcodelist.csv`
  - BARseq2 output processed through the BARseq3 computational pipeline.

- `BARseq2_cell_gene_classification`
...
- `BARseq3_cell_gene_classification`
...
## Code: Amplicons/Cell in barcoded cell
